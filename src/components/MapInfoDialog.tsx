  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md w-full">
        <DialogHeader>
          <DialogTitle>
            {isLoading ? "Streaming Information..." : "Add Information to Map?"}
          </DialogTitle>
          <DialogDescription>
            {isLoading ? "Information is being streamed in real-time." : "Would you like to add this information to the map?"}
          </DialogDescription>
        </DialogHeader>
